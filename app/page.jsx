  ...
  return (
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "120px 24px 80px", overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 2, maxWidth: 800 }}>
        ...
        <h1 style={{ ...hd, fontSize: 64, color: G.text, lineHeight: 1.1, marginBottom: 8 }}>For brands scaling with<br /><span style={{ color: G.textSec }}>Paid Social</span></h1>

        <div style={{ marginTop: 32, marginBottom: 16 }}>
          <p style={{ ...hd, fontSize: 32, color: G.text, lineHeight: 1.3 }}>Your ads aren't failing.</p>
          <p style={{ ...hd, fontSize: 32, color: G.gold, lineHeight: 1.3 }}>Your creative pipeline is.</p>
        </div>
  ...
  return (
    <section style={{ padding: "80px 24px", maxWidth: 800, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        ...
        <h2 style={{ ...hd, fontSize: 42, color: G.text, marginBottom: 24 }}>Founders. Operators. <span style={{ color: G.gold }}>Creatives.</span></h2>
      </div>
  ...
  return (
    <section id="how" style={{ padding: "80px 24px", maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 64 }}>
        ...
        <h2 style={{ ...hd, fontSize: 42, color: G.text, marginBottom: 12 }}>How Alchemy <span style={{ color: G.gold }}>Works</span></h2>
  ...
  return (
    <section style={{ padding: "80px 24px", maxWidth: 900, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        <h2 style={{ ...hd, fontSize: 38, color: G.text, marginBottom: 12 }}>The System Behind the <span style={{ color: G.gold }}>Results</span></h2>
  ...
  return (
    <section id="results" style={{ padding: "80px 24px", maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        ...
        <h2 style={{ ...hd, fontSize: 42, color: G.text, marginBottom: 12 }}>Real numbers from brands <span style={{ color: G.gold }}>scaling with Alchemy</span></h2>
      </div>
...
function Testimonials() {
  const testimonials = [
    { quote: "I honestly don't know where I'd be without the Oasis Team. When we started working together, I had no consistent income from my business, now we're scaling faster than we ever thought possible. Their marketing strategies are insanely smart, but what really stands out is how much they actually care. Andrew and the Oasis team has helped us generate over $500k in revenue so far.", name: "Peter D.", role: "Founder", company: "Luxury Landscape Design" },
    { quote: "Working with Andrew (and Oasis) has been the best business decision I've ever made. His knowledge of marketing and business has helped me achieve things i had spent years on without success. Their honesty and integrity is something I can rely on. Grateful to have them on my team.", name: "Aaron W.", role: "Founder", company: "Media Network" },
    { quote: "The Oasis Team helped us shape our brand from the ground up. They guided us through our marketing strategy with patience, breaking everything down clearly and helping us make smart decisions. Everything went smoother and faster thanks to them!", name: "Jenniska G.", role: "Founder", company: "Service Business" },
    { quote: "I have interviewed 30 agencies in the last few months. I haven't seen even one of them innovating at 1/10th the rate of the Oasis team. It is so exciting to watch them build this system and lead the way.", name: "Kathryn B.", role: "Founder", company: "Education Platform" },
  ];
  return (
    <section style={{ padding: "80px 24px", maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        <h2 style={{ ...hd, fontSize: 42, color: G.text, marginBottom: 12 }}>What Our Clients <span style={{ color: G.gold }}>Say</span></h2>
  ...
  return (
    <section style={{ padding: "80px 24px", maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        ...
        <h2 style={{ ...hd, fontSize: 42, color: G.text, marginBottom: 12 }}>Real Results From <span style={{ color: G.gold }}>Real Clients</span></h2>
...
function IsThisForYou() {
  ...
  return (
    <section style={{ padding: "80px 24px", maxWidth: 900, margin: "0 auto" }}>
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        <h2 style={{ ...hd, fontSize: 42, color: G.text, marginBottom: 12 }}>Is This <span style={{ color: G.gold }}>For You?</span></h2>
...
function CTA() {
  return (
    <section id="cta" style={{ padding: "80px 24px 60px", maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
      <h2 style={{ ...hd, fontSize: 42, color: G.text, marginBottom: 12 }}>Ready to fix your<br /><span style={{ color: G.gold }}>creative bottleneck?</span></h2>
...
function Footer() {
  return (
    <footer style={{ borderTop: `1px solid ${G.border}`, padding: "40px 24px", maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      <div>
