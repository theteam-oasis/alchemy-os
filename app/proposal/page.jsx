...
import { Sparkles, ArrowRight, Check, Zap, TrendingUp, Users, Quote } from "lucide-react";
...
const samples = [
  { src: "/assets/skincare-closeup-CKKAxIIz.png", label: "Skincare Studio Shot", category: "Product Photography" },
  { src: "/assets/scent-diffuser-studio-8F9hzFSi.png", label: "Diffuser Lifestyle", category: "Lifestyle Creative" },
  { src: "/assets/golf-ad-BF4ytyZB.jpeg", label: "Golf Performance Ad", category: "Performance Ad" },
  { src: "/assets/tallow-balm-ad-j98A_I8X.jpeg", label: "Tallow Balm Ad", category: "DTC Creative" },
  { src: "/assets/sock-scientific-tech-CtYs3SdE.jpeg", label: "Scientific Infographic", category: "Educational Ad" },
  { src: "/assets/ugc-socks-Dvn42rza.jpeg", label: "UGC Style Creative", category: "UGC Content" },
];
...
const packages = [
  {
    ...
    price: "$2,500",
    period: "/mo",
    description: "For brands testing AI creative at scale",
    icon: Zap,
    features: [
      "15 static ad creatives per month",
      "3 concept directions",
      "2 revision rounds",
      "Meta-optimized formats",
      "Performance copy variations",
  ...
  },
  {
    ...
    price: "$5,000",
    period: "/mo",
    description: "For brands ready to dominate Andromeda",
    icon: TrendingUp,
    features: [
      "40 static + 5 video creatives per month",
      "6 concept directions",
      "Unlimited revisions",
      "Meta + TikTok formats",
      "UGC-style scripts included",
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    description: "For agencies and high-spend brands",
    icon: Users,
    features: [
      "Unlimited creatives",
    ...
    <>
      ...
      <div style={{ maxWidth: 1120, margin: "0 auto", padding: "0 24px" }}>
        ...
        <section style={{ textAlign: "center", padding: "100px 0 80px" }}>
          ...
          <HeroBlurText as="h1" className="hero-proposal-title" style={{ ...hd, fontSize: 58, color: G.text, lineHeight: 1.1, marginBottom: 16, justifyContent: "center" }} staggerMs={70}>{"Creative That Converts"}</HeroBlurText>
            ...
            {samples.map((s, i) => (
              <BlurReveal key={i} style={{ borderRadius: 16, overflow: "hidden", border: `1px solid ${G.cardBorder}`, boxShadow: G.cardShadow, background: G.card }}>
                <div style={{ position: "relative", paddingTop: "125%", background: "#F5F5F7" }}>
                  <img src={s.src} alt={s.label} style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", objectFit: "cover" }} />
                </div>
                <div style={{ padding: "16px 20px" }}>
                  <span style={{ fontSize: 11, fontWeight: 600, color: G.textTer, letterSpacing: "0.08em", textTransform: "uppercase", ...mono }}>{s.category}</span>
                  <p style={{ fontSize: 15, fontWeight: 600, color: G.text, marginTop: 4, ...mono }}>{s.label}</p>
                </div>
              </BlurReveal>
            ))}
          </div>
