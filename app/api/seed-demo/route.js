...
async function upsertBrandIntake(clientId) {
  const payload = {
    ...
    story: "Lumen Skincare is a Brooklyn-based luxury skincare brand. Founded by a former esthetician who got tired of greenwashed lines that didn't work. Every formula is pH-balanced, fragrance-free, and tested on melanin-rich skin first.",
