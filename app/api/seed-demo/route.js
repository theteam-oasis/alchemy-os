...
async function upsertBrandIntake(clientId) {
  const payload = {
    ...
    unique_features: [
      ...
      "Tested on melanin-rich skin first",
      "Bakuchiol instead of retinol (no irritation)",
      "Mineral SPF 50 with no white cast on darker skin tones",
    ],
    testimonials: [
      "I've spent so much money on skincare. Lumen is the first thing in years where I noticed a difference in two weeks. — @theaonskin",
      "Finally a sunscreen that actually disappears on my skin. — Amara, NYC",
      "Three products, one routine, glowing skin. That's it. — @minimalistskin",
    ],
    // Tone
    tone_formality: 60,
    tone_mood: 70,
    ...
    voice_age: "28-38",
    voice_style: ["confident", "warm", "honest", "premium", "editorial"],
    voice_notes: "Like an esthetician friend, not a salesperson. Clinical but not cold. Skip the exclamation marks; let the formulas speak.",
    // Personality
    personality_tags: ["editorial", "minimal", "scientific", "warm", "honest"],
    // Music direction
    music_mood: ["warm", "ambient", "editorial"],
    music_genres: ["downtempo", "indie pop", "ambient electronic"],
    music_notes: "Avoid trendy TikTok pop. Lean into Phoebe Bridgers, Faye Webster, ambient synths. Slow builds, no drops.",
    // Video direction
    video_pace: 40,
    video_energy: 55,
    ...
    influencer_body_type: "athletic, average build",
    influencer_hair_color: "dark brown",
    influencer_hair_style: "long, loose, slightly undone",
    influencer_beauty_level: "natural editorial (not full glam)",
    influencer_style: "minimal, editorial, neutral palette",
    influencer_personality: "confident, calm, knowledgeable, conversational, dry-humored",
    influencer_notes: "Should feel like she actually uses the product, not a paid spokesperson. No script-reading energy. Filmed on iPhone Pro for authenticity, but lit cinematically.",
  };
